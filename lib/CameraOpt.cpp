...
void GetUrlFun(string sCode,string m_szCameraIp,char* pathpic,DWORD index)
{
                	...
                	string code_temp = URLEncode(sCode);
                	string pcPlateNo = "plateno="+code_temp;
...
printf("\n===== API Int ======\n%d\n",code);
                		...
                		if(code != -1)
                		{
                            ...
                            /*
                		    HVAPI_HANDLE_EX hHandle = HVAPI_OpenEx("192.168.28.26",NULL);
                                    if(hHandle == NULL)
                                    {
                            ...
                            */
                            ...
                            // 发送通知给java处理
                            string code_temp2 = replace_all(code_temp,"%","$");
                                            	string sUrl3 = "http://127.0.0.1/java/api/"+code_temp2+"/"+m_szCameraIp+"/"+temp;
